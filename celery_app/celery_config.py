...
task_routes = {
    ...
    'celery_app.celery_tasks.bitfinex_fetch_ohlcvs_mutual_basequote': {'queue': 'bitfinex'},
    ...
    'celery_app.celery_tasks.binance_fetch_ohlcvs_mutual_basequote': {'queue': 'binance'},
